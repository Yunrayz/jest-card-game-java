...
/**
 * Variante classique du Jest telle que définie dans le sujet
 */
public class ReglesBasiques implements Regles {
    private String nom = "Variante classique";
    private PartieControleur PC;

    public ReglesBasiques() {}
