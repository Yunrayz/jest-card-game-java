...
/**
 * Méthode définissant la stratégie "Haute", dans cette stratégie, le jour virtuel va :
 * <ol>
 *     <li>Proposer sa carte la plus haute comme carte visible</li>
 *     <li>Piocher la carte visible d'un joueur au hasard</li>
 * </ol>
 */
public class StrategieHaute implements Strategie {

    /**
     * Méthode permettant au joueur virtuel de proposer une carte, ici, sa carte la plus haute sera la carte qu'il proposera comme carte visible
    ...
    /**
     * Méthode permettant au joueur virtuel de piocher une carte. Ici, il va piocher la carte visible d'un joueur
    ...
    public void piocherCarte(PartieControleur controleur, ArrayList<Joueur> joueursDispos, Joueur joueur) {
        ...
        Carte carteChoisie = joueurChoisi.getCarteVisible();
        joueur.ajouterCarteJest(carteChoisie);
        joueurChoisi.retirerCartePiochee(carteChoisie);
        controleur.callbackTraitementPioche(joueur, joueurChoisi, carteChoisie);
    }
}
